...
public sealed class GatewayProducerWithLogger(ILogger<GatewayProducerWithLogger> logger, IGatewayRequest gatewayRequest, IPublishEndpoint bus, short delay = 3000)
